...
export const ru = {
  ...
  checkout: {
    ...
    delivery: {
      ...
      optionDescriptions: {
        PICKUP: "Заберите заказ самостоятельно",
        MOSCOW: "Курьерская доставка Яндекс Доставка",
        MOSCOW_REGION: "Курьерская доставка Яндекс Доставка",
        OTHER_REGIONS: "Стоимость рассчитывается индивидуально",
      },
      optionPrices: {
        PICKUP: "Бесплатно",
        MOSCOW: "1 000 ₽",
        MOSCOW_REGION: "2 000 ₽",
        OTHER_REGIONS: "Индивидуально",
      },
      noticeTitle: "Важно",
      noticeLines: [
