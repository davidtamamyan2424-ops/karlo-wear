...
export const ru = {
  ...
  checkout: {
    ...
    delivery: {
      ...
      regionsTitle: "Стоимость доставки",
      regions: [
        {
          title: "Москва",
          text: "Доставка курьером Яндекс Доставки — 1 000 ₽",
        },
        {
          title: "Ближайшее Подмосковье",
          text: "Доставка курьером Яндекс Доставки — 2 000 ₽",
        },
        {
          title: "Другие регионы России",
          text: "Стоимость доставки рассчитывается индивидуально после оформления заказа",
        },
      ],
      noticeTitle: "Важно",
      noticeLines: [
